file(REMOVE_RECURSE "/workspaces/CMake/Tests/CMakeTests/uploads")

if(EXISTS "/workspaces/CMake/Tests/CMakeTests/uploads/file1.png")
  message(FATAL_ERROR "error: file1.png exists - should have been deleted")
endif()
if(EXISTS "/workspaces/CMake/Tests/CMakeTests/uploads/file2.png")
  message(FATAL_ERROR "error: file2.png exists - should have been deleted")
endif()

file(MAKE_DIRECTORY "/workspaces/CMake/Tests/CMakeTests/uploads")

set(filename "/workspaces/CMake/Tests/CMakeTests/FileUploadInput.png")
if(NOT "/workspaces/CMake/Tests/CMakeTests" MATCHES "^/")
  set(slash /)
endif()
set(urlbase "file://${slash}/workspaces/CMake/Tests/CMakeTests/uploads")
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/workspaces/CMake/Tests/CMakeTests/uploads/file1.png"
...
execute_process(COMMAND ${CMAKE_COMMAND} -E md5sum
  "/workspaces/CMake/Tests/CMakeTests/uploads/file2.png"
